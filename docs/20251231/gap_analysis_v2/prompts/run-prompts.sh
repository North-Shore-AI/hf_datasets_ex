...
STATE_DIR="$PROJECT_ROOT/logs/hf-datasets-gap-impl"
LOG_DIR="$STATE_DIR/logs-$(date +%Y%m%d-%H%M%S)"
COMPLETED_FILE="$STATE_DIR/completed.txt"

# Implementation prompts - no version bumps, just implement and test
PROMPTS=(
  "01_dataset_dict_ops.md"
  "02_iterable_concatenate.md"
  "03_dataset_repeat.md"
  "04_imagefolder_format.md"
  "05_save_load_disk.md"
  "06_iterable_interleave.md"
  "07_with_transform.md"
  "08_format_xml.md"
  "09_format_sql.md"
  "10_audiofolder_format.md"
  "11_webdataset_format.md"
)
...
echo "HuggingFace Datasets Elixir Gap Implementation Runner"
echo "====================================================="
